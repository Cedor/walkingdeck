...
(6, '2', 2, 'Wolf Trap', 0, 0, '{"action" : "avoid", "avoid" : "zombie"}', NULL, '{"action" : "other"}', 0),
...
(10, '2', 6, 'Tallahassee', 0, 1, NULL, '{"action" : "escapeTalla"}', '{"action" : "other"}', 0),
...
(33, '3', 11, 'Domitille', 0, 1, '{"action" : "avoid", "avoid" : "zombieordie"}', NULL, '{"action" : "other"}', 0),

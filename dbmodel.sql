...
(6, '2', 2, 'Wolf Trap', 0, 0, '{"action" : "avoid", "avoid" : "zombie"}', NULL, '{"action" : "calamityignore", "number" : 1, "ignore" : "stress"}', 0),
(7, '2', 3, 'Clown', 1, 0, NULL, NULL, '{"action" : "bury", "bury" : "this"}', 0),
(8, '2', 4, 'Ellie and Joel', 0, 1, NULL, NULL, '{"action" : "calamity", "number" : 1}', 0),
(9, '2', 5, 'Kieren', 0, 1, '{"action" : "multiple", "number" : 2, "0" : {"action" : "other"}, "1" : {"action" : "bury", "bury" : "this"}}', NULL, '{"action" : "calamity", "number" : 1}', 0),
(10, '2', 6, 'Tallahassee', 0, 1, NULL, '{"action" : "escapeTalla"}', '{"action" : "calamity", "number" : 1}', 0),
(11, '2', 7, 'Gretchen', 0, 1, '{"action" : "multiple", "number" : 2, "0" : {"action" : "other"}, "1" : {"action" : "bury", "bury" : "this"}}', NULL, '{"action" : "calamity", "number" : 1}', 0),
...
(24, '3', 2, 'Site Manager', 1, 0, NULL, '{"action" : "draw", "number" : 1}', '{"action" : "calamity", "number" : 2}', 0),
(25, '3', 3, 'Glenn', 0, 1, NULL, '{"action" : "brainstorm"}', '{"action" : "calamityignore", "number" : 1, "ignore" : "hunger"}', 0),
(26, '3', 4, 'Murphy', 0, 1, '{"action" : "bury", "bury" : "this"}', NULL, '{"action" : "calamityaggravate2", "number" : 1, "aggravate1" : "break", "aggravate2" : "stress"}', 0),
...
(36, '3', 14, 'Zoey', 0, 1, '{"action" : "other"}', NULL, '{"action" : "calamity", "number" : 1}', 0),
(37, '3', 15, 'Jill', 0, 1, '{"action" : "multiple", "number" : 2, "0" : {"action" : "other"}, "1" : {"action" : "bury", "bury" : "this"}}', NULL, '{"action" : "calamity", "number" : 1}', 0),

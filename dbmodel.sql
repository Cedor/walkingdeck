...
(14, '2', 10, 'Bonfire', 0, 0, '{"action" : "draw", "number" : 3}', NULL, '{"action" : "heal", "number" : 3}', 0, '{"black" : {"text" : "Draw three peripeteias"}, "grey" : {"text" : "${heal} up to ${number} characters", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 3}}}'),
(15, '2', 11, 'Horse', 0, 0, '{"action" : "draw", "number" : 2}', NULL, '{"action" : "heal", "number" : 2}', 0, '{"black" : {"text" : "Draw two peripeteias"}, "grey" : {"text" : "${heal} up to ${number} characters", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 2}}}'),

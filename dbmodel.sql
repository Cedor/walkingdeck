...
(12, '2', 8, 'Robert', 0, 1, NULL, NULL, '{"action" : "nothing"}', 0, '{"grey" : {"text" : "When the third damaged is applied to Robert, remove him from the game"}}'),
(13, '2', 9, 'Brigade', 1, 0, NULL, NULL, '{"action" : "bite", "bite" : 2}', 1, '{"special" : {"text" : "Immediately memorise this peripeteia, then draw a new one"}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 2, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
(14, '2', 10, 'Bonfire', 0, 0, '{"action" : "draw", "number" : 3}', NULL, '{"action" : "heal", "number" : 3}', 0, '{"black" : {"text" : "Draw ${number} peripeteia(s)", "args" : {"number" : 3}}, "grey" : {"text" : "${heal} up to ${number} characters", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 3}}}'),
(15, '2', 11, 'Horse', 0, 0, '{"action" : "draw", "number" : 2}', NULL, '{"action" : "heal", "number" : 2}', 0, '{"black" : {"text" : "Draw ${number} peripeteia(s)", "args" : {"number" : 2}}, "grey" : {"text" : "${heal} up to ${number} characters", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 2}}}'),
(16, '2', 12, 'RV', 0, 0, '{"action" : "draw", "number" : 2}', NULL, '{"action" : "restore", "ressource" : "ressource_stress"}', 0, '{"black" : {"text" : "Draw ${number} peripeteia(s)", "args" : {"number" : 2}}, "grey" : {"text" : "${stress}", "args" : {"stress" : {"type" : "icon", "name" : "stress"}}}}'),
(17, '2', 13, 'Cellar', 0, 0, '{"action" : "avoid", "avoid" : "zombie"}', NULL, '{"action" : "heal", "number" : 3, "condition" : "hunger", "condition2" : "stress"}', 0, '{"black" : {"text" : "Avoid a zombie from your hand"}, "grey" : {"text" : "${heal} up to ${number} characters with ${hunger}/${stress}", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 3, "hunger" : {"type" : "icon", "name" : "hunger"}, "stress" : {"type" : "icon", "name" : "stress"}}}}'),
(18, '2', 14, 'Teddy Bear', 0, 0, '{"action" : "restore", "ressource" : "ressource_stress"}', NULL, '{"action" : "heal", "number" : 2, "condition" : "stress"}', 0, '{"black" : {"text" : "${stress}", "args" : {"stress" : {"type" : "icon", "name" : "stress"}}}, "grey" : {"text" : "${heal} up to ${number} characters with ${stress}", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 2, "stress" : {"type" : "icon", "name" : "stress"}}}}'),
(19, '2', 15, 'Wild Zero', 1, 0, '{"action" : "avoid", "avoid" : "bothdeck"}', NULL, '{"action" : "bite", "bite" : 2}', 0, '{"black" : {"text" : "Avoid the top card of both decks, all characters avoided will be buried"}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 2, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
(20, '2', 16, 'Voodoo', 1, 0, '{"action" : "removedisaster", "disaster" : "break"}', NULL, '{"action" : "bite", "bite" : 2}', 0, '{"black" : {"text" : "Definitively remove the two disasters ${break}", "args" : {"break" : {"type" : "icon", "name" : "break"}}}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 2, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
...
(23, '3', 1, 'Musicians', 1, 0, NULL, NULL, '{"action" : "bite", "bite" : 3}', 0, '{"grey" : {"text" : "${number} ${bite}", "args" : {"number" : 3, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
(24, '3', 2, 'Site Manager', 1, 0, NULL, '{"action" : "draw", "number" : 1}', '{"action" : "disaster", "number" : 2}', 0, '{"white" : {"text" : "Draw ${number} peripeteia(s)", "args" : {"number" : 1}}, "grey" : {"text" : "${disaster} ${disaster}", "args" : {"disaster" : {"type" : "icon", "name" : "disaster"}}}}'),
...
(27, '3', 5, 'Horde', 1, 0, NULL, NULL, '{"action" : "bite", "bite" : 3}', 1, '{"special" : {"text" : "Immediately memorise this peripeteia, then draw a new one"}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 3, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
(28, '3', 6, 'Butler', 1, 0, NULL, '{"action" : "consume", "ressource" : "ressource_stress"}', '{"action" : "bite", "bite" : 2}', 0, '{"white" : {"text" : "${consumeStress}", "args" : {"consumeStress" : {"type" : "icon", "name" : "consumedStress"}}}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 2, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
(29, '3', 7, 'Canned food', 0, 0, '{"action" : "nothing"}', '{"action" : "consume", "ressource" : "ressource_hunger"}', '{"action" : "heal", "number" : 2}', 0, '{"black" : {"text" : "No effect"}, "white" : {"text" : "${consumeHunger}", "args" : {"consumeHunger" : {"type" : "icon", "name" : "consumedHunger"}}}, "grey" : {"text" : "${heal} up to ${number} characters", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 2}}}'),
(30, '3', 8, 'Warehouse', 0, 0, '{"action" : "unearth"}', NULL, '{"action" : "heal", "number" : 5}', 0, '{"black" : {"text" : "Move the top peripeteia from the graveyard to the escaped zone"}, "grey" : {"text" : "${heal} up to ${number} characters", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 5}}}'),
(31, '3', 9, 'Medical alcohol', 0, 0, '{"action" : "avoid", "avoid" : "zombie"}', NULL, '{"action" : "heal", "number" : 3, "condition" : "break"}', 0, '{"black" : {"text" : "Avoid a zombie from your hand"}, "grey" : {"text" : "${heal} up to ${number} characters with ${break}", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 3, "break" : {"type" : "icon", "name" : "break"}}}}'),
(32, '3', 10, 'Map', 0, 0, '{"action" : "reveal"}', NULL, '{"action" : "heal", "number" : 2, "condition" : "stress"}', 0, '{"black" : {"text" : "Reveal the top peripeteia of each deck"}, "grey" : {"text" : "${heal} up to ${number} characters with ${stress}", "args" : {"heal" : {"type" : "icon", "name" : "heal"}, "number" : 2, "stress" : {"type" : "icon", "name" : "stress"}}}}'),
(33, '3', 11, 'Domitille', 0, 1, '{"action" : "avoid", "avoid" : "zombieordie"}', NULL, '{"action" : "bite", "bite" : 1}', 0, '{"black" : {"text" : "Avoid a zombie from your hand or bury this peripeteia"}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 1, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
(34, '3', 12, 'The reaper', 1, 0, '{"action" : "bury", "bury" : "character"}', NULL, '{"action" : "bite", "bite" : 3}', 0, '{"black" : {"text" : "Bury a character from your hand or bury this peripeteia"}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 3, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
(35, '3', 13, 'Controller', 1, 0, '{"action" : "fastmemorise", "from" : "deck"}', NULL, '{"action" : "bite", "bite" : 2}', 0, '{"black" : {"text" : "Memorise 2 peripeteias from one deck"}, "grey" : {"text" : "${number} ${bite}", "args" : {"number" : 2, "bite" : {"type" : "icon", "name" : "bite"}}}}'),
